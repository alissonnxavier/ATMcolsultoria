package com.example.consult.ui.sobre;
...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String descricao = "A ATM consultoria tem como missao apoiar organizaçoes";
        ...
        return new AboutPage( getActivity() )
                ...
                .addEmail("atendimento@consultoria.com.br", "email")
                .addWebsite("https://google.com/","Acesse nosso site")

                .addGroup("Redes sociais")
                .addFacebook("implementation 'io.github.medyo:android-about-page:2.0.0'", "Facebook")
                .addInstagram("", "Instagran")
                .addTwitter("", "Twitter")
                .addYoutube("", "Youtube")
                .addGitHub("", "GitHut")
